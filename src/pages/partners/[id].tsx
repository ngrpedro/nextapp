    ...
    <div>
      ...
      <main /* style={{backgroundImage: }} */>
        <div className="flex items-center justify-start gap-4">
          <p className="text-gray-700 hover:text-gray-500 cursor-pointer transition-all">
            Inicio
          </p>
          <CaretRight size={16} />
          <p className="text-gray-700 hover:text-gray-500 cursor-pointer transition-all">
          ...
          <div className="absolute top-[11rem] left-10">
            <div className="flex items-start justify-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-700">Psicologo especialista não sei no que.</p>
        ...
        <section className="mt-[12rem]">
          <div className="px-16 flex flex-col items-start justify-start gap-4">
            ...
            <p className="block">
              ...
              Possimus nisi modi porro placeat officia ratione dolore excepturi sint
              magni, voluptatum harum blanditiis atque ipsum corrupti, suscipit enim
              nihil.
            </p>
          </div>
        </section>
